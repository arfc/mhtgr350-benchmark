...
[Kernels]
  ...
  [./diffusion]
    ...
    diffusivity = 'k'
    variable = temp
    block = 'C1 C2 C3 C1b C2b C3b C1t C2t C3t breflec film1b film2b film3b treflec film1t film2t film3t ireflec oreflec film1 film2 film3 F1l1 F1l2 F1l3 F1l4 F1l5 F1l6 F1l7 F1l8 F1l9 F1l10 F2l1 F2l2 F2l3 F2l4 F2l5 F2l6 F2l7 F2l8 F2l9 F2l10 F3l1 F3l2 F3l3 F3l4 F3l5 F3l6 F3l7 F3l8 F3l9 F3l10'
...
[BCs]
  [./inlet]
    boundary = 'cool_top rest_top cool_bot rest_bot'
    type = DirichletBC
    variable = temp
    value = 750
  [../]
...
[Materials]
  ...
  [./film_th]
    ...
    block = 'film1 film2 film3 film1b film2b film3b film1t film2t film3t C1b C2b C3b C1 C2 C3 C1t C2t C3t'
  [../]
