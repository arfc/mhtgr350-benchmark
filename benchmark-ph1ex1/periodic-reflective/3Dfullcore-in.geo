...
Physical Volume("M232") = {25};
Physical Volume("M223") = {27};
...
Physical Volume("M232") += {53};
Physical Volume("M226") = {55};
...
Extrude {0, 0, -Hb/2} {
  Surface{159};  Surface{191};  Surface{223};  Surface{255};  Surface{287};
  Surface{319};  Surface{346};  Surface{373};  Surface{405};  Surface{437};
  Surface{469};  Surface{501};  Surface{533};  Surface{565};  Surface{597};
  Surface{624};  Surface{656};  Surface{688};  Surface{720};  Surface{752};
  Surface{784};  Surface{816};  Surface{848};  Surface{880};  Surface{912};
  Surface{979}; Surface{1281}; Surface{1453};
  Layers{Lb}; Recombine;
}

la = 10;
Physical Volume("M222") += {57+la*28, 63+la*28};
Physical Volume("M222") += {58+la*28};
Physical Volume("M222") += {59+la*28};
Physical Volume("M222") += {60+la*28};
Physical Volume("M222") += {61+la*28};
Physical Volume("M222") += {62+la*28};

Physical Volume("M222") += {64+la*28, 72+la*28};
Physical Volume("M222") += {65+la*28};
Physical Volume("M222") += {66+la*28};
Physical Volume("M222") += {67+la*28};
Physical Volume("M222") += {68+la*28};
Physical Volume("M222") += {69+la*28};
Physical Volume("M222") += {70+la*28};
Physical Volume("M222") += {71+la*28};

Physical Volume("M222") += {73+la*28};
Physical Volume("M222") += {74+la*28};
Physical Volume("M222") += {75+la*28};
Physical Volume("M222") += {76+la*28};
Physical Volume("M222") += {77+la*28};
Physical Volume("M222") += {78+la*28};
Physical Volume("M222") += {79+la*28};
Physical Volume("M222") += {80+la*28};

Physical Volume("M221") += {82+la*28};
Physical Volume("M223") += {81+la*28};
Physical Volume("M223") += {83+la*28};
Physical Volume("M224") += {84+la*28};

Physical Surface("ref_bot") = {
  16011, 16043, 16075, 16107, 16139,
  16171, 16198, 16225, 16257, 16289,
  16321, 16353, 16385, 16417, 16449,
  16476, 16508, 16540, 16572, 16604,
  16636, 16668, 16700, 16732, 16831,
  16764, 17133, 17305
};

Physical Surface("wall1") += {16830, 16010, 16208, 16896, 17304};
Physical Surface("wall2") += {16826, 16193, 16471, 17024, 17296};
Physical Surface("wall3") += {17300};
