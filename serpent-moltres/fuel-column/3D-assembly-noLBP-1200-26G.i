...
[Materials]
  [./fuel]
    ...
    property_tables_root = 'xs-assembly-nLBP-26G/mhtgr_homoge_'
    interp_type = 'linear'
    block = 'fuel'
  [../]
  [./breflector]
    type = GenericMoltresMaterial
    property_tables_root = 'xs-assembly-nLBP-26G/mhtgr_brefl_'
    interp_type = 'linear'
    block = 'breflector'
  [../]
  [./treflector]
    type = GenericMoltresMaterial
    property_tables_root = 'xs-assembly-nLBP-26G/mhtgr_trefl_'
    interp_type = 'linear'
    block = 'treflector'
  [../]
[]
...
[Outputs]
  ...
  file_base = '3D-assembly-noLBP-1200-26G'
